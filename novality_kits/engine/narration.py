...
def prose(t):
    ...
    t = re.sub(r"\bsl st\b", "slip stitch", t); t = re.sub(r"\bhdc\b", "half double crochet", t)
    ...
    t = re.sub(r"\bch\b", "chain", t); t = re.sub(r"\bFO\b", "fasten off", t); t = re.sub(r"\bMR\b", "magic ring", t)
