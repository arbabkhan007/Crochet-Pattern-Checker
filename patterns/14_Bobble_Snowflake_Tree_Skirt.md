...
**FINISHED SIZE**  Mini / tabletop: stop after R14 - 18-21 in (46-53 cm) across.  Standard: stop after R23 - 29-33 in (74-84 cm) across.  Large: stop after R32 - 38-43 in (97-109 cm) across.  Centre hole approximately 1.5-2 in unstretched (verify against your tree stand; ch 24 at the start for a larger opening).
...
Flat swatch in US dc, blocked lightly: 12 dc = 4 in (10 cm); 6 rounds = 4 in (10 cm). Measure the actual skirt as it grows.
...
Closed rounds, joined - do not turn. Ch 2 at round start never counts as a stitch. Work the first dc or BO into the SAME stitch as the join, mark it, and slip stitch to that marked stitch at round end. Twelve increase columns add 12 stitches every round; every third round from R5 is a bobble round (in CC if you like).

1. **The 12-spoke circle** - Round N of the growth ladder consumes N-1 and produces N stitches per each of its 12 repeats, so the stitch total after round N is always exactly 12 x N. R9 needs 7 plain dc and R10 needs 8 - one fewer and you run out of stitches before the round closes.

2. **The 5-dc bobble** - Yarn over, insert hook, pull up a loop, yarn over, pull through 2 loops (incomplete dc). Repeat 4 more times in the same stitch (6 loops on hook). Yarn over, pull through all 6. One bobble counts as ONE stitch; push it to the front.

3. **Changing colour at a join** - Work the final slip stitch of the round with the new colour, then begin the next round with it - no visible step.

4. **Surface snowflake spokes** - Surface slip stitches up each of the 12 increase columns in CC with a smaller hook. Keep them loose so the skirt stays flat.

## Instructions

### 1. Skirt - center ring and growth rounds

Ch 2 starts every round and is never counted. Work the first dc (or first BO on a bobble round) into the same stitch as the join, then end with sl st to that first actual stitch. Worked flat and circular throughout.
...
| R14 | Ch 2, [BO in next st, dc in next 11 sts, 2 dc in next st] x 12, sl st to first BO | Ch 2, [BO in next st, tr in next 11 sts, 2 tr in next st] x 12, sl st to first BO | (168) | MINI SIZE - continue to border here |
...
| R23 | Ch 2, [BO in next st, dc in next 20 sts, 2 dc in next st] x 12, sl st to first BO | Ch 2, [BO in next st, tr in next 20 sts, 2 tr in next st] x 12, sl st to first BO | (276) | STANDARD SIZE - continue to border here |
...
| R32 | Ch 2, [BO in next st, dc in next 29 sts, 2 dc in next st] x 12, sl st to first BO | Ch 2, [BO in next st, tr in next 29 sts, 2 tr in next st] x 12, sl st to first BO | (384) | LARGE SIZE - continue to border here |

#### Scalloped border

| Rnd | US terms | UK terms | Sts | Note |
|---|---|---|---|---|
| - | Join CC in any st; ch 1, [sc in next st, skip 2 sts, 5 dc in next st, skip 2 sts] around, sl st to first sc, FO | Join CC in any st; ch 1, [dc in next st, skip 2 sts, 5 tr in next st, skip 2 sts] around, sl st to first dc, FO | - | repeats consume 6 sts each; R14 gives 28, R23 gives 46, R32 gives 64 scallops |
...
All three endings are divisible by 6, so the scallop border closes cleanly at every size.
