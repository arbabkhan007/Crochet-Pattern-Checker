...
| R2 | Ch 2, 2 dc in same st as join, 2 dc in each of next 11 sts, sl st to first dc | Ch 2, 2 tr in same st as join, 2 tr in each of next 11 sts, sl st to first tr | (24) | - |
| R3 | Ch 2, dc in same st as join, 2 dc in next st, [dc in next st, 2 dc in next st] x 11, sl st to first dc | Ch 2, tr in same st as join, 2 tr in next st, [tr in next st, 2 tr in next st] x 11, sl st to first tr | (36) | - |
| R4 | Ch 2, dc in same st as join, dc in next st, 2 dc in next st, [dc in next 2 sts, 2 dc in next st] x 11, sl st to first dc | Ch 2, tr in same st as join, tr in next st, 2 tr in next st, [tr in next 2 sts, 2 tr in next st] x 11, sl st to first tr | (48) | - |
| R5 | Ch 2, BO in same st as join, dc in next 2 sts, 2 dc in next st, [BO in next st, dc in next 2 sts, 2 dc in next st] x 11, sl st to first BO | Ch 2, BO in same st as join, tr in next 2 sts, 2 tr in next st, [BO in next st, tr in next 2 sts, 2 tr in next st] x 11, sl st to first BO | (60) | first bobble round |
| R6 | Ch 2, dc in same st as join, dc in next 3 sts, 2 dc in next st, [dc in next 4 sts, 2 dc in next st] x 11, sl st to first dc | Ch 2, tr in same st as join, tr in next 3 sts, 2 tr in next st, [tr in next 4 sts, 2 tr in next st] x 11, sl st to first tr | (72) | - |
| R7 | Ch 2, dc in same st as join, dc in next 4 sts, 2 dc in next st, [dc in next 5 sts, 2 dc in next st] x 11, sl st to first dc | Ch 2, tr in same st as join, tr in next 4 sts, 2 tr in next st, [tr in next 5 sts, 2 tr in next st] x 11, sl st to first tr | (84) | - |
| R8 | Ch 2, BO in same st as join, dc in next 5 sts, 2 dc in next st, [BO in next st, dc in next 5 sts, 2 dc in next st] x 11, sl st to first BO | Ch 2, BO in same st as join, tr in next 5 sts, 2 tr in next st, [BO in next st, tr in next 5 sts, 2 tr in next st] x 11, sl st to first BO | (96) | - |

#### Rounds 9-16

| Rnd | US terms | UK terms | Sts | Note |
|---|---|---|---|---|
| R9 | Ch 2, dc in same st as join, dc in next 6 sts, 2 dc in next st, [dc in next 7 sts, 2 dc in next st] x 11, sl st to first dc | Ch 2, tr in same st as join, tr in next 6 sts, 2 tr in next st, [tr in next 7 sts, 2 tr in next st] x 11, sl st to first tr | (108) | - |
| R10 | Ch 2, dc in same st as join, dc in next 7 sts, 2 dc in next st, [dc in next 8 sts, 2 dc in next st] x 11, sl st to first dc | Ch 2, tr in same st as join, tr in next 7 sts, 2 tr in next st, [tr in next 8 sts, 2 tr in next st] x 11, sl st to first tr | (120) | - |
| R11 | Ch 2, BO in same st as join, dc in next 8 sts, 2 dc in next st, [BO in next st, dc in next 8 sts, 2 dc in next st] x 11, sl st to first BO | Ch 2, BO in same st as join, tr in next 8 sts, 2 tr in next st, [BO in next st, tr in next 8 sts, 2 tr in next st] x 11, sl st to first BO | (132) | - |
| R12 | Ch 2, dc in same st as join, dc in next 9 sts, 2 dc in next st, [dc in next 10 sts, 2 dc in next st] x 11, sl st to first dc | Ch 2, tr in same st as join, tr in next 9 sts, 2 tr in next st, [tr in next 10 sts, 2 tr in next st] x 11, sl st to first tr | (144) | - |
| R13 | Ch 2, dc in same st as join, dc in next 10 sts, 2 dc in next st, [dc in next 11 sts, 2 dc in next st] x 11, sl st to first dc | Ch 2, tr in same st as join, tr in next 10 sts, 2 tr in next st, [tr in next 11 sts, 2 tr in next st] x 11, sl st to first tr | (156) | - |
| R14 | Ch 2, BO in same st as join, dc in next 11 sts, 2 dc in next st, [BO in next st, dc in next 11 sts, 2 dc in next st] x 11, sl st to first BO | Ch 2, BO in same st as join, tr in next 11 sts, 2 tr in next st, [BO in next st, tr in next 11 sts, 2 tr in next st] x 11, sl st to first BO | (168) | MINI SIZE - continue to border here |
| R15 | Ch 2, dc in same st as join, dc in next 12 sts, 2 dc in next st, [dc in next 13 sts, 2 dc in next st] x 11, sl st to first dc | Ch 2, tr in same st as join, tr in next 12 sts, 2 tr in next st, [tr in next 13 sts, 2 tr in next st] x 11, sl st to first tr | (180) | - |
| R16 | Ch 2, dc in same st as join, dc in next 13 sts, 2 dc in next st, [dc in next 14 sts, 2 dc in next st] x 11, sl st to first dc | Ch 2, tr in same st as join, tr in next 13 sts, 2 tr in next st, [tr in next 14 sts, 2 tr in next st] x 11, sl st to first tr | (192) | - |

#### Rounds 17-24

| Rnd | US terms | UK terms | Sts | Note |
|---|---|---|---|---|
| R17 | Ch 2, BO in same st as join, dc in next 14 sts, 2 dc in next st, [BO in next st, dc in next 14 sts, 2 dc in next st] x 11, sl st to first BO | Ch 2, BO in same st as join, tr in next 14 sts, 2 tr in next st, [BO in next st, tr in next 14 sts, 2 tr in next st] x 11, sl st to first BO | (204) | - |
| R18 | Ch 2, dc in same st as join, dc in next 15 sts, 2 dc in next st, [dc in next 16 sts, 2 dc in next st] x 11, sl st to first dc | Ch 2, tr in same st as join, tr in next 15 sts, 2 tr in next st, [tr in next 16 sts, 2 tr in next st] x 11, sl st to first tr | (216) | - |
| R19 | Ch 2, dc in same st as join, dc in next 16 sts, 2 dc in next st, [dc in next 17 sts, 2 dc in next st] x 11, sl st to first dc | Ch 2, tr in same st as join, tr in next 16 sts, 2 tr in next st, [tr in next 17 sts, 2 tr in next st] x 11, sl st to first tr | (228) | - |
| R20 | Ch 2, BO in same st as join, dc in next 17 sts, 2 dc in next st, [BO in next st, dc in next 17 sts, 2 dc in next st] x 11, sl st to first BO | Ch 2, BO in same st as join, tr in next 17 sts, 2 tr in next st, [BO in next st, tr in next 17 sts, 2 tr in next st] x 11, sl st to first BO | (240) | - |
| R21 | Ch 2, dc in same st as join, dc in next 18 sts, 2 dc in next st, [dc in next 19 sts, 2 dc in next st] x 11, sl st to first dc | Ch 2, tr in same st as join, tr in next 18 sts, 2 tr in next st, [tr in next 19 sts, 2 tr in next st] x 11, sl st to first tr | (252) | - |
| R22 | Ch 2, dc in same st as join, dc in next 19 sts, 2 dc in next st, [dc in next 20 sts, 2 dc in next st] x 11, sl st to first dc | Ch 2, tr in same st as join, tr in next 19 sts, 2 tr in next st, [tr in next 20 sts, 2 tr in next st] x 11, sl st to first tr | (264) | - |
| R23 | Ch 2, BO in same st as join, dc in next 20 sts, 2 dc in next st, [BO in next st, dc in next 20 sts, 2 dc in next st] x 11, sl st to first BO | Ch 2, BO in same st as join, tr in next 20 sts, 2 tr in next st, [BO in next st, tr in next 20 sts, 2 tr in next st] x 11, sl st to first BO | (276) | STANDARD SIZE - continue to border here |
| R24 | Ch 2, dc in same st as join, dc in next 21 sts, 2 dc in next st, [dc in next 22 sts, 2 dc in next st] x 11, sl st to first dc | Ch 2, tr in same st as join, tr in next 21 sts, 2 tr in next st, [tr in next 22 sts, 2 tr in next st] x 11, sl st to first tr | (288) | - |

#### Rounds 25-32

| Rnd | US terms | UK terms | Sts | Note |
|---|---|---|---|---|
| R25 | Ch 2, dc in same st as join, dc in next 22 sts, 2 dc in next st, [dc in next 23 sts, 2 dc in next st] x 11, sl st to first dc | Ch 2, tr in same st as join, tr in next 22 sts, 2 tr in next st, [tr in next 23 sts, 2 tr in next st] x 11, sl st to first tr | (300) | - |
| R26 | Ch 2, BO in same st as join, dc in next 23 sts, 2 dc in next st, [BO in next st, dc in next 23 sts, 2 dc in next st] x 11, sl st to first BO | Ch 2, BO in same st as join, tr in next 23 sts, 2 tr in next st, [BO in next st, tr in next 23 sts, 2 tr in next st] x 11, sl st to first BO | (312) | - |
| R27 | Ch 2, dc in same st as join, dc in next 24 sts, 2 dc in next st, [dc in next 25 sts, 2 dc in next st] x 11, sl st to first dc | Ch 2, tr in same st as join, tr in next 24 sts, 2 tr in next st, [tr in next 25 sts, 2 tr in next st] x 11, sl st to first tr | (324) | - |
| R28 | Ch 2, dc in same st as join, dc in next 25 sts, 2 dc in next st, [dc in next 26 sts, 2 dc in next st] x 11, sl st to first dc | Ch 2, tr in same st as join, tr in next 25 sts, 2 tr in next st, [tr in next 26 sts, 2 tr in next st] x 11, sl st to first tr | (336) | - |
| R29 | Ch 2, BO in same st as join, dc in next 26 sts, 2 dc in next st, [BO in next st, dc in next 26 sts, 2 dc in next st] x 11, sl st to first BO | Ch 2, BO in same st as join, tr in next 26 sts, 2 tr in next st, [BO in next st, tr in next 26 sts, 2 tr in next st] x 11, sl st to first BO | (348) | - |
| R30 | Ch 2, dc in same st as join, dc in next 27 sts, 2 dc in next st, [dc in next 28 sts, 2 dc in next st] x 11, sl st to first dc | Ch 2, tr in same st as join, tr in next 27 sts, 2 tr in next st, [tr in next 28 sts, 2 tr in next st] x 11, sl st to first tr | (360) | - |
| R31 | Ch 2, dc in same st as join, dc in next 28 sts, 2 dc in next st, [dc in next 29 sts, 2 dc in next st] x 11, sl st to first dc | Ch 2, tr in same st as join, tr in next 28 sts, 2 tr in next st, [tr in next 29 sts, 2 tr in next st] x 11, sl st to first tr | (372) | - |
| R32 | Ch 2, BO in same st as join, dc in next 29 sts, 2 dc in next st, [BO in next st, dc in next 29 sts, 2 dc in next st] x 11, sl st to first BO | Ch 2, BO in same st as join, tr in next 29 sts, 2 tr in next st, [BO in next st, tr in next 29 sts, 2 tr in next st] x 11, sl st to first BO | (384) | LARGE SIZE - continue to border here |

#### Scalloped border

| Rnd | US terms | UK terms | Sts | Note |
|---|---|---|---|---|
| - | Join CC in any st; ch 1, sc in same st, skip 2 sts, 5 dc in next st, skip 2 sts, [sc in next st, skip 2 sts, 5 dc in next st, skip 2 sts] around, sl st to first sc, FO | Join CC in any st; ch 1, dc in same st, skip 2 sts, 5 tr in next st, skip 2 sts, [dc in next st, skip 2 sts, 5 tr in next st, skip 2 sts] around, sl st to first dc, FO | (12 x N) | 6 sts per repeat; scallops = 2 x N, so it closes after any round |
...
| Rnd | US terms | UK terms | Sts | Note |
|---|---|---|---|---|
| - | Join CC beside an increase column at the centre; surface sl st outward over each of the 12 columns, FO | Join CC beside an increase column at the centre; surface sl st outward over each of the 12 columns, FO | - | 12 spokes, one per increase column |
