...
STANDARD_TOKENS = {
    ...
    "only", "same", "space", "spaces", "corner", "between", "along", "tog",
    "skip", "skips", "nose", "this", "again", "at", "beside", "bow",
    "centre", "column", "columns", "ends", "flower", "for", "green",
    "hanging", "increase", "leaf", "leaves", "length", "marker", "matching",
    "measures", "once", "outward", "pairs", "place", "point", "red",
    "row", "rows", "round", "rounds", "see", "silver", "spiral", "surface",
    "table", "tail", "tails", "target", "tube", "until", "untwisted",
