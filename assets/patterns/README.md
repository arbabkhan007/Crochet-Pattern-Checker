...
These files support the provisional Novality Crochet Studio PDF editions. They
are **illustrations, not photographs of physically tested samples**.

| Designs | Asset type | Production note |
|---|---|---|
...
sample photograph is present in this asset tree.

Before commercial publication, the owner must confirm the right to use every
visual output, preserve the relevant generation/licence records, complete the
current Etsy disclosure review, and replace illustrative visuals with
rights-cleared real photographs where the listing or pattern implies a physical
sample. Never use these files to claim that a design was crocheted, measured,
washed, durability-tested or safety-assessed.
