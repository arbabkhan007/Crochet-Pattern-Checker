...
class GlossaryPrePassExtractor:
    ...
    def _parse_definition(self, line: str, line_num: int) -> GlossaryEntry:
        ...
        if match:
            ...
            is_complex = any(re.search(pattern, abbrev) for pattern in self.complex_patterns)
    ...
    def _is_common_word(self, word: str) -> bool:
        ...
        common_words = {
            'in', 'next', 'st', 'sts', 'each', 'around', 'rep', 'from',
            'to', 'and', 'the', 'a', 'an', 'of', 'into', 'skip', 'space',
            'round', 'row', 'ch', 'sp', 'turn', 'work', 'working'
        }
