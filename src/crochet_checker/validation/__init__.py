...
# Optional validators (may have issues in some environments)
try:
...
__all__ = [
    "validate_pattern", "validate_stitch_counts", "ValidationReport", "Severity",
    "StitchCountValidator", "StitchCountReport", "ValidationFinding",
    "RowTransitionValidator", "TransitionReport",
    "ConsistencyValidator", "ConsistencyReport",
    "MultiPieceDetector", "detect_and_validate_multipiece",
]
