...
class PremiumChartGenerator:
    def __init__(self):
        self.chart_styles = {
            "traditional": {"symbol_size": "medium", "grid": "visible", "colors": "standard"},
            "modern": {"symbol_size": "large", "grid": "minimal", "colors": "vibrant"},
            "elegant": {"symbol_size": "medium", "grid": "subtle", "colors": "muted"},
            "professional": {"symbol_size": "large", "grid": "visible", "colors": "high_contrast"}
        }
    ...
    def export_chart_svg(self, chart_data: dict) -> str:
        ...
        svg += f'  <text x="200" y="30" text-anchor="middle" font-size="20">Premium Crochet Chart</text>\n'
        svg += '</svg>'
        return svg
