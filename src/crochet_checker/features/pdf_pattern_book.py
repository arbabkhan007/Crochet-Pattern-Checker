...
class PDFPatternBook:
    ...
    def _create_back_cover(self):
        ...
        self.pdf.multi_cell(
            0, 10, "From beginner-friendly basics\nto advanced techniques", align="C"
        )
        ...
        self.pdf.cell(
            0,
            8,
            f"© {datetime.now().year} {self.author}. All rights reserved.",
            align="C",
        )
...
if __name__ == "__main__":
    ...
    book.add_pattern(
        ...
        difficulty="Intermediate",
        materials={
            "Yarn": "Worsted in white & pink",
            "Hook": "3.5mm",
            "Extras": "Safety eyes, stuffing",
        },
        instructions=[
            "Head (make 1):",
    ...
    result = book.build_book(
        output,
        author_bio="Jane Smith is a passionate crochet designer with 10 years of experience. She loves creating patterns that are both beautiful and accessible.",
    )
