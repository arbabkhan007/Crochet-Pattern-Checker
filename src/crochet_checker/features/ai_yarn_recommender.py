...
class AIYarnRecommender:
    ...
    YARN_DATABASE = [
        {
            ...
            "price": 4.99,
            "colors": 50,
            "best_for": ["blankets", "scarves", "amigurumi"],
            "season": "all",
        },
        {
            "name": "Scheepjes Catona",
            "brand": "Scheepjes",
            "weight": "dk",
            "fiber": "cotton",
            "yardage": 50,
            "price": 2.50,
            "colors": 100,
            "best_for": ["amigurumi", "dishcloths", "doilies"],
            "season": "all",
        },
        {
            "name": "Malabrigo Rios",
            ...
            "price": 15.99,
            "colors": 60,
            "best_for": ["scarves", "shawls", "garments"],
            "season": "fall",
        },
        {
            ...
            "price": 2.49,
            "colors": 20,
            "best_for": ["dishcloths", "market bags", "tops"],
            "season": "summer",
        },
        {
            "name": "Cascade 220",
            ...
            "price": 9.99,
            "colors": 100,
            "best_for": ["sweaters", "hats", "mittens"],
            "season": "winter",
        },
        {
            "name": "WeCrochet Brava",
            "brand": "WeCrochet",
            "weight": "dk",
            "fiber": "acrylic",
            "yardage": 218,
            "price": 3.99,
            "colors": 80,
            "best_for": ["garments", "blankets", "accessories"],
            "season": "all",
        },
    ]
    ...
    def recommend_yarn(
        ...
        candidates = [
            y
            for y in candidates
            if project_type.lower() in [b.lower() for b in y.get("best_for", [])]
        ]
        ...
        if season:
            ...
            candidates = [
                y
                for y in candidates
                if y["fiber"].lower() in [f.lower() for f in seasonal_fibers]
            ]
    ...
    def _score_yarn(
        self, yarn: dict, project_type: str, season: str, difficulty: str
    ) -> float:
    ...
    def find_substitute(self, original_yarn: str, project_type: str = "") -> dict:
        ...
        substitutes = [
            y
            for y in self.YARN_DATABASE
            if y["weight"] == original["weight"] and y["name"] != original["name"]
        ]
        ...
        for yarn in substitutes:
            ...
            if project_type:
                if project_type.lower() in [
                    b.lower() for b in yarn.get("best_for", [])
                ]:
                    score += 30
        ...
        return {
            ...
            "suggestion": f"Best match: {scored[0]['name']} (score: {scored[0]['match_score']}/100)"
            if scored
            else "No good substitutes found",
        }
