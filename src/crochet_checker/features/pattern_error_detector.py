...
class PatternErrorDetector:
    def __init__(self):
        self.error_rules = {
            "missing_turning_chain": {"severity": "medium", "fix": "Add turning chain at start of row"},
            "stitch_count_mismatch": {"severity": "high", "fix": "Check stitch count at end of each row"},
            "inconsistent_abbreviations": {"severity": "low", "fix": "Use consistent abbreviations"},
            "missing_repeat_instructions": {"severity": "medium", "fix": "Add clear repeat instructions"},
        }
