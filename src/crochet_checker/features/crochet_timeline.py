...
class CrochetTimeline:
    ...
    def get_journey_stats(self) -> dict:
        ...
        return {
            ...
            "most_active_year": max(by_year.items(), key=lambda x: x[1])[0]
            if by_year
            else None,
        }
    ...
    def get_year_highlights(self, year: int) -> dict:
        ...
        return {
            ...
            "highlights": [
                ...
                if e["type"] in ("achievement", "milestone", "challenge")
            ],
        }
    ...
    def generate_timeline_html(self) -> str:
        ...
        items = ""
        for event in events:
            type_info = self.MILESTONE_TYPES.get(
                event["type"], self.MILESTONE_TYPES["project"]
            )
...
if __name__ == "__main__":
    ...
    # Add events
    timeline.add_event(
        "Learned single crochet",
        "first_project",
        "2023-01-15",
        "Made my first chain and sc!",
        tags=["beginner", "first"],
    )

    timeline.add_event(
        "First amigurumi bunny",
        "project",
        "2023-03-20",
        "Completed my first stuffed animal",
        tags=["amigurumi"],
    )
    ...
    timeline.add_event(
        ...
        "new_skill",
        "2023-06-10",
        "Tried tapestry crochet for the first time",
        tags=["colorwork", "skill"],
    )
