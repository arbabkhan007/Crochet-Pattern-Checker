...
class OrderManager:
    ...
    def calculate_price(
        ...
        return {
            ...
            "recommended_price": round(
                max(recommended_price, self.PRICING_FACTORS["minimum_order"]), 2
            ),
    ...
    def get_dashboard(self) -> dict:
        ...
        profit = sum(
            o.total_price - o.materials_cost
            for o in self.orders.values()
            if o.status in ("delivered", "shipped")
        )
                ...
                urgent.append(
                    {
                        ...
                        "status": o.status,
                        "urgency": "🔴"
                        if o.days_until_deadline <= 3
                        else "🟡"
                        if o.days_until_deadline <= 7
                        else "🟢",
                    }
                )
...
<div class="footer">
    ...
    def display_dashboard(self):
        ...
        print(f"\n{'=' * 60}")
        print("  CROCHET BUSINESS DASHBOARD")
        print(f"{'=' * 60}")
        ...
        if urgent:
            ...
            for o in urgent:
                ...
                print(
                    f"     Due: {o['deadline']} ({o['days_left']} days) | Status: {o['status']}"
                )
