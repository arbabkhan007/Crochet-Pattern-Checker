...
class ChallengeSystem:
    ...
    DAILY_CHALLENGES = [
        {
            "name": "Starter Stitches",
            "desc": "Complete 10 single crochets",
            "category": "basic",
            "difficulty": "easy",
            "points": 10,
        },
        {
            "name": "Chain Master",
            "desc": "Chain 50 stitches in a row",
            "category": "basic",
            "difficulty": "easy",
            "points": 10,
        },
        {
            "name": "Round Tracker",
            "desc": "Complete 3 rounds of any pattern",
            "category": "progress",
            "difficulty": "easy",
            "points": 15,
        },
        {
            "name": "Yarn Explorer",
            "desc": "Try a new yarn weight today",
        ...
        {
            "name": "Speed Demon",
            "desc": "Crochet for 30 minutes straight",
            "category": "time",
            "difficulty": "medium",
            "points": 25,
        },
        {
            "name": "Color Play",
            "desc": "Use 3 different colors in one project",
            "category": "colorwork",
            "difficulty": "medium",
            "points": 20,
        },
        {
            "name": "Magic Ring Master",
            "desc": "Start a project with magic ring",
            "category": "technique",
            "difficulty": "easy",
            "points": 10,
        },
        {
            "name": "Count Check",
            "desc": "Verify stitch counts for 5 rounds",
            "category": "validation",
            "difficulty": "easy",
            "points": 15,
        },
        {
            "name": "Photo Memory",
            "desc": "Take a progress photo of your WIP",
        ...
        {
            "name": "Pattern Reader",
            "desc": "Read through a full pattern before starting",
    ...
    WEEKLY_CHALLENGES = [
        {
            "name": "Finish Line",
            "desc": "Complete a full project this week",
            "category": "completion",
            "difficulty": "hard",
            "points": 100,
        },
        {
            "name": "New Technique",
            "desc": "Learn a new stitch or technique",
            "category": "learning",
            "difficulty": "medium",
            "points": 50,
        },
        {
            "name": "Granny Square",
            "desc": "Make a complete granny square",
            "category": "classic",
            "difficulty": "medium",
            "points": 40,
        },
        {
            "name": "Amigurumi Animal",
            "desc": "Start or finish an amigurumi animal",
            "category": "amigurumi",
            "difficulty": "hard",
            "points": 75,
        },
        {
            "name": "Gift Maker",
            "desc": "Make something as a gift for someone",
            "category": "gifting",
            "difficulty": "medium",
            "points": 60,
        },
        {
            "name": "Stash Dive",
            "desc": "Use yarn from your stash you haven't touched in 6+ months",
            "category": "stash",
            "difficulty": "medium",
            "points": 40,
        },
    ...
    MONTHLY_CHALLENGES = [
        {
            "name": "Blanket Month",
            "desc": "Complete a blanket or afghan",
            "category": "blanket",
            "difficulty": "hard",
            "points": 300,
        },
        ...
        {
            "name": "Wardrobe Piece",
            "desc": "Make a wearable item",
            "category": "fashion",
            "difficulty": "hard",
            "points": 200,
        },
        {
            "name": "Charity Crochet",
            "desc": "Make 3 items for charity",
            "category": "charity",
            "difficulty": "hard",
            "points": 350,
        },
    ...
    ACHIEVEMENTS = {
        ...
        "streak_7": {
            "name": "Week Warrior",
            "desc": "7-day crochet streak",
            "icon": "🔥",
        },
        "streak_30": {
            "name": "Monthly Master",
            "desc": "30-day crochet streak",
            "icon": "🌟",
        },
        "streak_100": {
            "name": "Centurion",
            "desc": "100-day crochet streak",
            "icon": "💎",
        },
        "projects_5": {
            "name": "Productive",
        ...
        "projects_25": {
            "name": "Prolific",
            "desc": "Complete 25 projects",
            "icon": "👑",
        },
        "patterns_validated_10": {
            "name": "Eagle Eye",
            "desc": "Validate 10 patterns",
            "icon": "🦅",
        },
        "patterns_validated_50": {
            "name": "Quality Inspector",
            "desc": "Validate 50 patterns",
            "icon": "🔍",
        },
        "all_categories": {
            "name": "Renaissance",
            "desc": "Complete challenges in all categories",
            "icon": "🎨",
        },
        "night_owl": {
            "name": "Night Owl",
            "desc": "Complete a challenge after midnight",
            "icon": "🦉",
        },
        "early_bird": {
            "name": "Early Bird",
            "desc": "Complete a challenge before 7am",
            "icon": "🐦",
        },
    }
    ...
    def load(self):
        if self.storage_path.exists():
            try:
                ...
                self.user_data["categories_completed"] = set(
                    data.get("categories_completed", [])
                )
            except Exception:
                pass
    ...
    def get_daily_challenge(self) -> dict:
        ...
        if self.user_data.get("challenge_date") != today or not self.user_data.get(
            "daily_challenge"
        ):
    ...
    def _check_achievements(self) -> list[dict]:
        ...
        if (
            "first_stitch" not in unlocked
            and len(self.user_data["completed_challenges"]) >= 1
        ):
    ...
    def get_profile(self) -> dict:
        ...
        progress = (
            (self.user_data["xp"] - xp_current) / max(1, xp_for_next - xp_current)
        ) * 100
        ...
        return {
            ...
            "achievements_unlocked": len(
                self.user_data.get("unlocked_achievements", [])
            ),
    ...
    def display_profile(self):
        ...
        print(f"\n{'=' * 50}")
        print(
            f"  {profile['level_icon']} Level {profile['level']}: {profile['level_name']}"
        )
        print(f"{'=' * 50}")
        print(
            f"  XP: {profile['xp']} / {profile['xp_for_next']} ({profile['level_progress']}%)"
        )
        ...
        print(
            f"  🏆 Achievements: {profile['achievements_unlocked']}/{profile['total_achievements']}"
        )
