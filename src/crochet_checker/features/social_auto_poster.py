...
""".strip()
    ...
    def generate_pinterest_pin(self, pattern_name: str, description: str = "") -> dict:
        ...
        return {
            ...
            or f"Beautiful {pattern_name} crochet pattern. Perfect for beginners and advanced crocheters alike. Get the pattern now!",
...
if __name__ == "__main__":
    ...
    print("\n📸 Instagram Post:")
    ig = poster.generate_instagram_post(
        pattern_name, "Warm and cozy blanket perfect for winter!"
    )
