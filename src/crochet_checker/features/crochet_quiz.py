...
class CrochetQuiz:
    ...
    QUESTIONS = [
        QuizQuestion(
            ...
            "beginner",
            10,
            "sc = single crochet, the most basic stitch",
        ),
        QuizQuestion(
            "Q002",
            "stitches",
            "Which stitch is taller than a single crochet?",
            ["Slip stitch", "Half double crochet", "Chain stitch", "Magic ring"],
            1,
            "beginner",
            10,
            "HDC is taller than SC but shorter than DC",
        ),
        QuizQuestion(
            "Q003",
            "stitches",
            "What is a 'frog' in crochet?",
            [
                "A type of yarn",
            ...
            "beginner",
            15,
            "Frog = rip it out (sounds like a frog!)",
        ),
        QuizQuestion(
            "Q004",
            "tools",
            "What hook size is most common for worsted weight yarn?",
            ["2.0mm", "4.0mm (G/6)", "6.0mm (J)", "10.0mm"],
            1,
            "beginner",
            10,
            "G/6 (4.0mm) is standard for worsted weight",
        ),
        QuizQuestion(
            "Q005",
            "techniques",
            ...
            "intermediate",
            15,
            "Gauge = stitches per inch, crucial for sizing",
        ),
        QuizQuestion(
            "Q006",
            "stitches",
            ...
            "intermediate",
            15,
            "Treble uses more yarn per stitch than DC or SC",
        ),
        QuizQuestion(
            "Q007",
            "patterns",
            "What does '(inc)' mean in a pattern?",
        ...
        QuizQuestion(
            ...
            "beginner",
            10,
            "DK = Double Knitting, lighter than worsted",
        ),
        QuizQuestion(
            "Q009",
            "techniques",
            ...
            [
                "A type of hook",
                "Japanese crochet for stuffed toys",
                "A stitch pattern",
                "A yarn brand",
            ],
            1,
            "beginner",
            15,
            "Amigurumi = Japanese art of crochet stuffed toys",
        ),
        QuizQuestion(
            "Q010",
            "stitches",
            "How many chains typically start a DC row?",
            ["1", "2", "3", "4"],
            2,
            "intermediate",
            10,
            "3 chains = turning chain for DC",
        ),
        QuizQuestion(
            "Q011",
            "techniques",
            "What is a magic ring/magic circle?",
            [
                "A type of ring to wear",
                "Adjustable starting loop for circles",
                "A stitch pattern",
                "A tool",
            ],
            1,
        ...
        QuizQuestion(
            ...
            "beginner",
            10,
            "rep = repeat the following instructions",
        ),
        QuizQuestion(
            "Q013",
            "yarn",
            "Which fiber is NOT natural?",
            ["Cotton", "Wool", "Acrylic", "Silk"],
            2,
            "beginner",
            10,
            "Acrylic is synthetic; others are natural fibers",
        ),
        QuizQuestion(
            "Q014",
            "techniques",
            ...
            [
                "Preventing stitches",
                "Shaping finished work with moisture",
                "A type of stitch",
                "Cutting yarn",
            ],
            1,
            "intermediate",
            15,
            "Blocking shapes and sets your finished piece",
        ),
        QuizQuestion(
            "Q015",
            "advanced",
            ...
            [
                "A stitch around the post of previous row",
                "A social media stitch",
                "A decrease",
                "An increase",
            ],
            0,
            "advanced",
            20,
            "Post stitches work around the stitch post for texture",
        ),
        QuizQuestion(
            "Q016",
            "techniques",
            ...
            [
                ...
                "Crocheting in a spiral or joined rounds",
                "Making a circle",
                "Turning work",
            ],
            1,
            "beginner",
            15,
            "Working in the round = continuous circles without turning",
        ),
        QuizQuestion(
            "Q017",
            "stitches",
            "Which is the shortest stitch?",
            ["Chain", "Slip stitch", "Single crochet", "Half double"],
            1,
            "beginner",
            10,
            "Slip stitch is the shortest/flat stitch",
        ),
        QuizQuestion(
            "Q018",
            "yarn",
            ...
            "intermediate",
            15,
            "Superwash wool can be machine washed",
        ),
        QuizQuestion(
            "Q019",
            "patterns",
            ...
            [
                "Starting over",
                "Instructions to do multiple times",
                "A mistake",
                "A different color",
            ],
            1,
            "beginner",
            10,
            "Repeat = do the same instructions again",
        ),
        QuizQuestion(
            "Q020",
            "advanced",
            ...
            [
                "Crochet with tape",
                "Multi-color crochet carrying yarn",
                "Crochet on tapestry fabric",
                "A brand",
            ],
            1,
            "advanced",
            20,
            "Tapestry crochet = colorwork carrying unused yarn inside",
        ),
    ]
    ...
    ACHIEVEMENTS = {
        ...
        "all_categories": {
            "name": "Well Rounded",
            "desc": "Answer from every category",
            "xp": 75,
            "icon": "🌟",
        },
        "perfect_score": {
    ...
    def get_questions_for_quiz(
        self, count: int = 5, category: str = None, difficulty: str = None
    ) -> list[QuizQuestion]:
    ...
    def answer_question(self, question_id: str, selected: int) -> dict:
        ...
        new_achievements = []
        if (
            self.data["current_streak"] >= 3
            and "streak_3" not in self.data["achievements"]
        ):
            new_achievements.append("streak_3")
        if (
            self.data["current_streak"] >= 10
            and "streak_10" not in self.data["achievements"]
        ):
    ...
    def complete_quiz(self, correct: int, total: int) -> dict:
        ...
        if (
            self.data["quizzes_completed"] == 1
            and "first_quiz" not in self.data["achievements"]
        ):
        ...
        if (
            len(self.data["categories_answered"]) >= len(self.CATEGORIES)
            and "all_categories" not in self.data["achievements"]
        ):
            new_achievements.append("all_categories")
        if (
            self.data["daily_streak"] >= 7
            and "daily_player" not in self.data["achievements"]
        ):
    ...
    def get_player_stats(self) -> dict:
        ...
        accuracy = (
            self.data["total_correct"] / max(1, self.data["total_answered"])
        ) * 100
    ...
    def get_learning_path(self) -> list[dict]:
        ...
        path = [
            {
                "level": 1,
                "topic": "Basic Stitches (SC, DC, HDC)",
                "status": "completed" if stats["level"] > 1 else "current",
            },
            {
                "level": 2,
                "topic": "Reading Patterns & Abbreviations",
                "status": "locked"
                if stats["level"] < 2
                else "completed"
                if stats["level"] > 2
            ...
            },
            {
                "level": 3,
                "topic": "Gauge & Sizing",
                "status": "locked" if stats["level"] < 3 else "current",
            },
            {
                "level": 4,
                "topic": "Colorwork & Techniques",
                "status": "locked" if stats["level"] < 4 else "current",
            },
            {
                "level": 5,
                "topic": "Advanced Stitches & Design",
                "status": "locked" if stats["level"] < 5 else "current",
            },
        ]
