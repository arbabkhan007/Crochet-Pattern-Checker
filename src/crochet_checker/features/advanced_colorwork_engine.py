...
class AdvancedColorworkEngine:
    ...
    def _get_tension_tips(self, colorwork_type: str) -> list:
        tips = {
            'tapestry': ['Keep carried yarn loose', 'Don\'t pull working yarn too tight'],
            'intarsia': ['Twist yarns at color changes', 'Use separate bobbins for each color'],
            'fair_isle': ['Catch floats every 3-4 stitches', 'Keep floats uniform length']
        }
