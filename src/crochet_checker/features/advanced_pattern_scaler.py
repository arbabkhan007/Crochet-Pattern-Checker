...
class AdvancedPatternScaler:
    ...
    def scale_pattern(
        ...
        target_size: dict,
        scaling_method: str = "proportional",
    ) -> dict:
        ...
        scaled_pattern = {
            ...
            "adjusted_stitches": self._calculate_adjusted_stitches(
                original_pattern, scale_factor, scaling_method
            ),
            "adjusted_rows": self._calculate_adjusted_rows(
                original_pattern, scale_factor, scaling_method
            ),
    ...
    def _calculate_adjusted_stitches(
        self, original: dict, factor: float, method: str
    ) -> int:
    ...
    def _get_scaling_notes(self, method: str) -> list:
        notes = {
            "linear": [
                ...
                "May not maintain pattern integrity",
                "Best for basic patterns",
            ],
            "proportional": [
                "Maintains pattern repeats",
                "Better for complex patterns",
                "Calculates multiples automatically",
            ],
            "shaped": [
                "Accounts for shaping changes",
                "Most accurate for 3D items",
