...
class CrochetMoodRing:
    ...
    MOODS = {
        "happy": {
            ...
            "suggestions": [
                {
                    "project": "Colorful Granny Square Blanket",
                    "difficulty": "intermediate",
                    "time": "15+ hours",
                    "why": "Bright colors match your mood!",
                },
                {
                    "project": "Rainbow Amigurumi Set",
                    "difficulty": "beginner",
                    "time": "8 hours",
                    "why": "Fun and playful!",
                },
                {
                    "project": "Floral Mandala",
                    "difficulty": "advanced",
                    "time": "10 hours",
                    "why": "Beautiful and rewarding",
                },
            ],
        },
        "calm": {
            ...
            "suggestions": [
                {
                    "project": "Simple Scarf in Soft Yarn",
                    "difficulty": "beginner",
                    "time": "6 hours",
                    "why": "Mindless and soothing",
                },
                {
                    "project": "Repeating Stitch Blanket",
                    "difficulty": "beginner",
                    "time": "20 hours",
                    "why": "Rhythmic and meditative",
                },
                {
                    "project": "Lace Doily",
                    "difficulty": "advanced",
                    "time": "12 hours",
                    "why": "Peaceful precision",
                },
            ],
        },
        "stressed": {
            ...
            "suggestions": [
                {
                    "project": "Simple Dishcloths",
                    "difficulty": "beginner",
                    "time": "2 hours",
                    "why": "Quick wins reduce stress",
                },
                {
                    "project": "Chunky Cowl",
                    "difficulty": "beginner",
        ...
        "creative": {
            ...
            "suggestions": [
                {
                    "project": "Design Your Own Pattern",
                    "difficulty": "advanced",
                    "time": "10+ hours",
                    "why": "Channel that creativity!",
                },
                {
                    "project": "Freeform Crochet Art",
                    "difficulty": "intermediate",
                    "time": "8 hours",
                    "why": "No rules, just expression",
                },
                {
                    "project": "Mosaic Colorwork",
                    "difficulty": "advanced",
                    "time": "15 hours",
                    "why": "Complex and beautiful",
                },
            ],
        },
        "bored": {
            ...
            "suggestions": [
                {
                    "project": "Learn a New Stitch",
                    "difficulty": "intermediate",
                    "time": "3 hours",
                    "why": "Challenge yourself!",
                },
                {
                    "project": "Amigurumi Animal",
                    "difficulty": "intermediate",
                    "time": "6 hours",
                    "why": "Fun and engaging",
                },
                {
                    "project": "Complex Lace Shawl",
                    "difficulty": "advanced",
                    "time": "20 hours",
                    "why": "Keeps your mind busy",
                },
            ],
        },
        "nostalgic": {
            ...
            "suggestions": [
                {
                    "project": "Vintage Lace Collar",
                    "difficulty": "advanced",
                    "time": "8 hours",
                    "why": "Classic and timeless",
                },
                {
                    "project": "Traditional Afghan",
                    "difficulty": "intermediate",
                    "time": "25 hours",
                    "why": "Heirloom quality",
                },
                {
                    "project": "Antique-Style Doilies",
                    "difficulty": "advanced",
                    "time": "10 hours",
                    "why": "Old-world charm",
                },
        ...
        "energetic": {
            ...
            "suggestions": [
                {
                    "project": "Quick Amigurumi Batch",
                    "difficulty": "beginner",
                    "time": "8 hours",
                    "why": "Make multiple small items fast",
                },
                {
                    "project": "Striped T-Shirt Yarn Basket",
                    "difficulty": "beginner",
                    "time": "4 hours",
                    "why": "Fast and practical",
                },
                {
                    "project": "Beanie Collection",
                    "difficulty": "beginner",
                    "time": "6 hours",
                    "why": "Quick projects, big impact",
                },
            ],
        },
        "focused": {
            ...
            "suggestions": [
                {
                    "project": "Intricate Lace Shawl",
                    "difficulty": "advanced",
                    "time": "30 hours",
                    "why": "Requires concentration",
                },
                {
                    "project": "Tapestry Crochet Bag",
                    "difficulty": "advanced",
                    "time": "12 hours",
                    "why": "Complex colorwork",
                },
                {
                    "project": "Fitted Garment",
                    "difficulty": "advanced",
                    "time": "20 hours",
                    "why": "Precision required",
                },
            ],
        },
    }
    ...
    def suggest_by_mood(
        self, mood: str, energy_level: str = None, time_available: str = None
    ) -> dict:
        ...
        if energy_level:
            ...
            allowed = energy_map.get(
                energy_level, ["beginner", "intermediate", "advanced"]
            )
        ...
        if time_available:
            time_map = {
                "quick": ["1-3 hours", "2 hours", "3 hours", "4 hours"],
...
if __name__ == "__main__":
    ...
    result = ring.suggest_by_mood(
        "stressed", energy_level="low", time_available="quick"
    )
