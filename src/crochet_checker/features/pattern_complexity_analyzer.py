...
class PatternComplexityAnalyzer:
    def __init__(self):
        self.complexity_weights = {
            "sc": 1, "dc": 2, "hdc": 1.5, "tr": 3, "sl_st": 0.5,
            "inc": 2, "dec": 2, "fpdc": 3, "bpdc": 3,
            "magic_ring": 3, "bobble": 4, "popcorn": 4,
        }
    ...
    def analyze_complexity(self, pattern_text: str) -> dict:
        ...
        for line in lines:
            ...
            for technique, weight in self.complexity_weights.items():
                ...
                if count > 0:
                    technique_count[technique] = technique_count.get(technique, 0) + count
    ...
    def _get_recommendations(self, difficulty: str) -> list:
        ...
        recommendations = {
            "Beginner": ["Perfect for learning", "Take your time", "Practice basic stitches first"],
            "Easy": ["Good for confident beginners", "Read pattern thoroughly before starting"],
            "Intermediate": ["Some experience required", "Practice special stitches separately"],
            "Advanced": ["Significant experience needed", "Make gauge swatch first"],
            "Expert": ["For experienced crocheters only", "Expect challenges", "Allow extra time"]
        }
