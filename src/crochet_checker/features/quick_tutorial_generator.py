...
class QuickTutorialGenerator:
    ...
    def generate_text_tutorial(
        self, pattern_name: str, steps: list, difficulty: str = "Beginner"
    ):
...
"""
    ...
    def generate_all_formats(
        ...
        results = {
            ...
            "markdown": self.generate_markdown_tutorial(
                pattern_name, steps, difficulty
            ),
        }
