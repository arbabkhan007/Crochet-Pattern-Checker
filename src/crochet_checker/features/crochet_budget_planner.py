...
class CrochetBudgetPlanner:
    ...
    def _load_data(self):
        if self.data_file.exists():
            with open(self.data_file, "r") as f:
                return json.load(f)
        return {"expenses": [], "income": [], "projects": [], "monthly_budget": 200.0}
    ...
    def add_income(
        self, source: str, amount: float, description: str, date: str = None
    ):
    ...
    def get_financial_summary(self) -> dict:
        ...
        return {
            ...
            "budget_remaining": self.data["monthly_budget"]
            - sum(
                e["amount"]
                for e in self.data["expenses"]
...
if __name__ == "__main__":
    ...
    pricing = planner.calculate_suggested_price(
        materials_cost=35.00, hours=12.0, hourly_rate=15.0, profit_margin=0.30
    )
