...
class YarnBehaviorPredictor:
    def __init__(self):
        self.yarn_properties = {
            ...
            "cotton": {"stretch": 0.05, "memory": 0.3, "warmth": 0.3, "durability": 0.9},
            "acrylic": {"stretch": 0.10, "memory": 0.5, "warmth": 0.6, "durability": 0.8},
            "alpaca": {"stretch": 0.20, "memory": 0.7, "warmth": 0.98, "durability": 0.6},
            "bamboo": {"stretch": 0.08, "memory": 0.4, "warmth": 0.4, "durability": 0.7},
        }
    
    def predict_behavior(self, yarn_type: str, pattern_type: str) -> dict:
        """Predict yarn behavior in specific pattern"""
        props = self.yarn_properties.get(yarn_type.lower(), self.yarn_properties["acrylic"])
