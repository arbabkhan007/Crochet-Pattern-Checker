...
class PDFInvoiceGenerator:
    ...
    def create_receipt(
        ...
        self.pdf.cell(
            30, 10, f"${amount_paid or total:.2f}", border=1, align="R", fill=True
        )
...
if __name__ == "__main__":
    ...
    items = [
        {
            "description": 'Custom Granny Square Blanket (50" × 60")',
            "quantity": 1,
            "price": 150.00,
        },
        {
            "description": "Matching Pillow Covers (set of 2)",
            "quantity": 1,
            "price": 45.00,
        },
        {
            "description": "Amigurumi Bunny (custom colors)",
            "quantity": 2,
            "price": 25.00,
        },
