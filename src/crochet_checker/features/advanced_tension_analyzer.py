...
class AdvancedTensionAnalyzer:
    ...
    def analyze_tension(
        self, pattern_text: str, crocheter_profile: str = "normal"
    ) -> dict:
        """Analyze tension characteristics"""
        profile = self.tension_profiles.get(
            crocheter_profile, self.tension_profiles["normal"]
        )
