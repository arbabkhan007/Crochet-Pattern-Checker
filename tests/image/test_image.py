...
from crochet_checker.image import ImageConfig, ImageProvider, generate_pattern_image


class TestImage:
    def test_placeholder(self):
        r = ImageProvider(ImageConfig(provider="placeholder")).generate_cover_image(
            "Test", "hat"
        )
        assert "<svg" in r
